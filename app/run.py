...
db_path = r'D:\Code\UDacity Project\Disaster-Response-Pipelines\data\DisasterResponse.db'
...
model_path = os.path.abspath("D:/Code/UDacity Project/Disaster-Response-Pipelines/models/classifier.pkl")

# Tải mô hình từ tệp classifier.pkl
